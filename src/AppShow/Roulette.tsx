...
const Roulette = () => {
  ...
  return (
  <>
  <Heading as="h1">ルーレット</Heading>
    <Textarea onChange={handleChange} autosize placeholder="項目を改行で分けてください" minRows={4}></Textarea>
    <div style={{textAlign:"center"}}>
  <Button onClick={handle}>スタート</Button>
  <Heading as="h2" style={{marginTop:30}}>結果</Heading>
